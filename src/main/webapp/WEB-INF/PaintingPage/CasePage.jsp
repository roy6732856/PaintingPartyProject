									...
									<div
											...
											<div class="u-container-layout u-container-layout-6">
												...
												<div class="form-row d-flex">
													<div class="form-group col-md-12 p-2">
														<label for="inputLowBudget">單張稿酬預算</label><br />
										...
										<div
											...
											<div class="form-group col-md-6 p-2">
												<label for="inputLowBudget">畫作風格：</label><br /><div class="" style="color: burlywood; font-size: 30px">
															${style}</div><br /> 
											</div>
											<div class="form-group col-md-6 p-2">
												<label for="inputLowBudget">創作類型：</label><br /><div class="" style="color: burlywood; font-size: 30px">
															${type}</div><br /> 
											</div>
										</div>
									</div>
