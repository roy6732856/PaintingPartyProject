	...
	$(document).ready(function() {
		$.ajax({
			...
			success : function(data) {
				...
				$('#memberName').append(data[0].member_name);
				$('#sc').append(data[0].schedule);
				$('#memberName2').append(data[1].member_name);
				$('#sc2').append(data[1].schedule);
				$('#memberName3').append(data[2].member_name);
				$('#sc3').append(data[2].schedule);
				$('#memberName4').append(data[3].member_name);
				$('#sc4').append(data[3].schedule);
				$('#memberName5').append(data[4].member_name);
				$('#sc5').append(data[4].schedule);
				$('#memberName6').append(data[5].member_name);
				$('#sc6').append(data[5].schedule);
