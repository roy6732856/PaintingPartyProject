                        ...
                        <div class="u-container-layout u-container-layout-6">
                          ...
                          <div class="u-border-1 u-border-grey-75 u-container-style u-group u-shape-rectangle u-group-5">
                           ...
                           <!-- 訂單 notice_content -->
                            ...
                            <sql:query var="oresult">
							select TOP (1) member_id,notice_title,notice_content,notice_date
							from order_notice
							where member_id = 1
							</sql:query>
							<c:forEach var="ono" items="${oresult.rows }">
							${ono.notice_content }
							</c:forEach>
                            </div>
                          </div>
                          ...
                          <p class="u-large-text u-text u-text-default u-text-variant u-text-3">通知</p>
                      ...
                      <div class="u-border-1 u-border-palette-5-light-1 u-container-style u-group u-radius-5 u-shape-round u-white u-group-9">
                        <div class="u-container-layout u-container-layout-12">
                          ...
                          <div class="u-border-1 u-border-grey-75 u-container-style u-group u-shape-rectangle u-group-11">
                            ...
                            <!-- 公告 notice_content -->
                            <sql:query var="sresult">
							select system_notice_id,notice_title,notice_content,notice_date
							from system_notice
							where system_notice_id = 1
							</sql:query>
                            <c:forEach var="sno" items="${sresult.rows }">
							${ sno.notice_content}
							</c:forEach>
