...
<link rel="stylesheet" href="resources/css/CaseForm(DataEntry).css"
	media="screen">
...
<body class="u-body u-overlap">
	...
	<section class="u-align-center u-clearfix u-grey-5 u-section-1"
		...
		<div class="u-align-left u-clearfix u-sheet u-sheet-1">
			...
			<div
				class="u-align-left u-container-style u-group u-radius-30 u-shape-round u-white u-group-1 form-group">
				<div
              ...
              <input type="text" class="form-control" id="inputDate" placeholder="請選擇日期">
						...
						<div class="form-group">
							<label for="StyleSelect">作品風格</label> <select
								class="form-control" id="StyleSelect">
                ...
                <label class="form-check-label" for="AccPub">
                  同意公開(選填)
						...
						<div class="col form-group" style="width: 200px;">
							...
							</label> <img id="preview_progressbarTW_img" class="img-thumbnail"
