...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/CaseApply.css" media="screen">
    ...
    <meta property="og:title" content="CaseApply">
                ...
                <div class="u-container-layout u-container-layout-1">
                    <form action="#" method="GET">
                        <div class="modal-header">
                            <h5 class="modal-title"><strong>案件報價單</strong></h5>
                        </div>
                        <div class="nodal-body px-3 py-3">
                            <div class="row">
                                <div class="col-12 col-lg-9 py-3">
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">預估時間</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            placeholder="預估工作天" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput2">期待酬勞</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput2"
                                            placeholder="請輸入新臺幣" required>
                                    </div>
