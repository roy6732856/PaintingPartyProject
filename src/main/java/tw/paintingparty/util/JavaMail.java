...
public class JavaMail {
	// ---------------------------------------------------------基本資料
		...
		private String userName = "s3251994@gmail.com"; // 寄件者信箱
		private String password = "ihyqlbmnklroirak"; // 寄件者密碼
		private String customer = "a0930699347@gmail.com"; // 收件者郵箱
//		private String subject = "測試郵件"; // 標題
//		private String txt = "<h1>郵件內容</h1><h2>文字內容</h2>"; // 內容

		public void SendMail(String txt,String subject) {
			// ---------------------------------------------------------連線設定
